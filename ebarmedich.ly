...
arranger = "arr. Joseph R. Lewis, changes A. Wąsowski"
...
guitarUpperVoice = \relative c {
	...
	\partial 8 fis8
	\acciaccatura { b16[ cis] } d8. \stemUp cis16 b8 \appoggiatura cis-2 b8.-0 ais16-2 b8-0 b4. ~ b4 b8
	\slurUp g'8. [( fis32 g a8] ~ a8.) g16 fis8 \appoggiatura fis-1 e4.-0 ~ e8. g16 e8
	...
	\fbarre #"II" { e32[( d cis16) b8( ais16) b-.] cis32[( b ais?16) g!8( fis16) g] g32[( fis e16) ais?8.( g32 fis)] g[( fis e16) cis'8.( fis,32 e)] }
	\fbarre #"II" { fis32[( e dis16) c8( b16) } a'32( g)] a[( g fis16) e8( dis?16) c'32-1( b)] c[( b a16) g8( fis16) fis'32( e)] fis[( e) dis16) c?8( b16 fis')]
...
guitarLowerVoice = \relative c {
	...
	b b b a a a g g g fis fis fis | 
	  ...
	  >>  e, e } \fbarre #"II" { fis fis fis } g e g b g b
	e e e d d d cis-2 \glissando cis \glissando cis ais-4 \glissando ais \glissando ais 
	\fbarre #"II" { b b b g g g fis cis' e e } ais,-1 cis-3 
